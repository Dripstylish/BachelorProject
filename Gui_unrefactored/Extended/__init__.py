...
class Builder:
    """
    A class used to initialise the main core screen easily
    """
...
class QBoxVertical(QVBoxLayout):
    """
    An extension of QVBoxLayout that fully stretches across the screen
    """
...
class QBoxHorizontal(QHBoxLayout):
    """
    An extension of QHBoxLayout that fully stretches across the screen
    """
...
class Scaffold(Widget):
    """
    A widget used as the main scaffold of an core
    """
